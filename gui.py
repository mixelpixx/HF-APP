...
class MainWindow(QMainWindow):
    ...
    cancel_download_signal = pyqtSignal()
    ...
    def setup_style(self):
        if self.current_theme == "light":
            self.setStyleSheet("""
                QToolTip { color: #ffffff; background-color: #4a86e8; border: 1px solid white; }
            ...
            self.setStyleSheet("""
                QToolTip { color: #e0e0e0; background-color: #76a9ea; border: 1px solid white; }
    ...
    def setup_search_tab(self):
        ...
        self.search_input.setToolTip("Enter model name or keyword to search")
        ...
        self.library_filter.setToolTip("Filter models by library")
    ...
    def setup_settings_tab(self):
        ...
        self.api_key_input.setToolTip("Enter your Hugging Face API key")
        ...
        self.download_dir_input.setToolTip("Set the default directory for downloads")
        ...
        self.theme_selector.setToolTip("Select application theme")
    ...
    def setup_inference_tab(self):
        ...
        self.input_text.setToolTip("Enter input text or data")
        ...
        self.run_inference_button.setToolTip("Run inference with the specified model and input")
        ...
        self.output_text.setToolTip("Inference result displayed here")
    ...
    def browse_download_dir(self):
        ...
        if dir_path:
            ...
            self.default_dir_signal.emit(dir_path)
    ...
    def update_progress(self, value):
        ...
        if value == 100:
            QMessageBox.information(self, "Download Complete", "The model has been successfully downloaded.")
